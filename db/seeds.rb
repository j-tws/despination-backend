...
d2 = Destination.create!(
    ...
    address: "30-3 Higashihashizumecho, Higashiyama Ward, Kyoto, 605-0847, Japan",
    longitude: nil,
    latitude: nil
)
...
d3 = Destination.create!(
    ...
    address: "Av. Governador Carlos Lacerda - Jacarepaguá, Rio de Janeiro - RJ, Brazil",
    longitude: nil,
    latitude: nil
)
...
a17 = Attraction.create!(
    ...
    category_id: c3.id,
    address: "581 Obiyacho, Nakagyo Ward, Kyoto, 604-8124, Japan",
    longitude: nil, 
    latitude: nil,
